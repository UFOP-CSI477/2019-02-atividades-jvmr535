  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #563D7C;">
      ...
      <ul class="navbar-nav">
          ...
          @else
            <li class="nav-item"><a href="/listarProtocolos" class="nav-link">Listar Protocolos</a></li>
            <li class="nav-item"><a href="/criarProtocolo" class="nav-link">Criar Protocolos</a></li>
            <li class="nav-item"><a href="/requisitarProtocolos" class="nav-link">Fazer Requerimento</a></li>
